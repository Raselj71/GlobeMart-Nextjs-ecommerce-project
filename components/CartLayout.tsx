  ...
  return (
    ...
    >
      <div className="w-full flex justify-end">
        <button className="cursor-pointer text-xl hover:bg-mainColoer hover:text-white transition-all duration-300 ease-in" onClick={handleClick}>
      ...
      <div>
        <hr />
          ...
          <div className="flex justify-center items-center mt-2">
             <button className="font-bold bg-mainColoer text-white text-lg font-mono  px-10 py-1 rounded-full hover:bg-black hover:text-white transition-all duration-300 ease-in">CHECKOUT</button>
          </div>
      </div>
    </div>
  );
